...
![](https://github.com/zhucourage/imgDB/images/image-20221001223920740.png)
...
![](https://github.com/zhucourage/imgDB/images/image-20221010211734734.png)
...
![](https://github.com/zhucourage/imgDB/images/image-20221010232231398.png)
...
![image-20221010211734734](https://github.com/zhucourage/imgDB/images/image-20221002172105310.png)
...
![image-20221010232231398](https://github.com/zhucourage/imgDB/images/image-20221011101958018.png)
...
![image-20221011094004893](https://github.com/zhucourage/imgDB/images/image-20221013102458999.png)
...
![image-20221011101958018](https://github.com/zhucourage/imgDB/images/image-20221011094004893.png)
...
![image-20221013102458999](https://github.com/zhucourage/imgDB/images/image-20221001223706955.png)
...
![image-20221015223248421](https://github.com/zhucourage/imgDB/images/image-20221015223248421.png)
...
![image-20221015225101435](https://github.com/zhucourage/imgDB/images/image-20221020205315159.png)
...
![image-20221015232223199](https://github.com/zhucourage/imgDB/images/image-20221015225101435.png)
...
![image-20221016180710251](https://github.com/zhucourage/imgDB/images/image-20221016180710251.png)
...
![image-20221020205315159](https://github.com/zhucourage/imgDB/images/image-20221020205711806.png)

即使是在黄金时期，算力也不是单调递增的，中间也是有很多波动，但总的来说是增长得非常快的。

挖矿难度的变化情况：

![image-20221020205536500](https://github.com/zhucourage/imgDB/images/image-20221021084103386.png)

挖矿难度的变化情况和算力的增长基本上是同步的，也符合难度调整的设计目标。通过调整挖矿难度，使得出块时间保持稳定。注意：挖矿难度不是目标阈值

最近半年的难度调整曲线：

![image-20221020205711806](https://github.com/zhucourage/imgDB/images/image-20221020205536500.png)
...
![image-20221021084103386](https://github.com/zhucourage/imgDB/images/image-20221015232223199.png)
...
<img src="https://github.com/zhucourage/imgDB/images/image-20221102141858291.png" alt="image-20221102141114234" style="zoom:67%;" />
...
![image-20221102141858291](https://github.com/zhucourage/imgDB/images/image-20221102142712231.png)
...
![image-20221102142712231](https://github.com/zhucourage/imgDB/images/image-20221102141114234.png)
...
![image-20221102143604234](https://github.com/zhucourage/imgDB/images/image-20221102144729545.png)
...
![image-20221102144729545](https://github.com/zhucourage/imgDB/images/image-20221102221311546.png)
...
![image-20221102221311546](https://github.com/zhucourage/imgDB/images/image-20221102143604234.png)
...
![image-20221102222414464](https://github.com/zhucourage/imgDB/images/image-20221102225308104.png)
...
![image-20221102222902652](https://github.com/zhucourage/imgDB/images/image-20221102222414464.png)

与前者的区别在于输出脚本里没有直接给出收款人的公钥，而是公钥的哈希。输入脚本既要给出付款人的签名，也要给出付款人的公钥。输出脚本里其他还有一些操作，这些操作都是为了验证签名的正确性。这种形式实际上是最常用的。

![image-20221102223758578](https://github.com/zhucourage/imgDB/images/image-20221102222902652.png)
...
3. PUSHDATA (PubKeyHash) ：把输出脚本里提供的收款人的公钥的哈希值压入栈。此时栈顶有两个哈希值
   ...
   ![image-20221102225308104](https://github.com/zhucourage/imgDB/images/image-20221102223758578.png)
...
![image-20221107173712918](https://github.com/zhucourage/imgDB/images/image-20221107173712918.png)
...
![image-20221107175053866](https://github.com/zhucourage/imgDB/images/image-20221107175053866.png)
...
![image-20221107181256922](https://github.com/zhucourage/imgDB/images/image-20221107181256922.png)
...
![image-20221107184844854](https://github.com/zhucourage/imgDB/images/image-20221107185613015.png)
...
![image-20221107185613015](https://github.com/zhucourage/imgDB/images/image-20221107190110807.png)
...
![image-20221107190110807](https://github.com/zhucourage/imgDB/images/image-20221108032452786.png)
...
![image-20221108032452786](https://github.com/zhucourage/imgDB/images/image-20221108213427226.png)
...
![image-20221108213427226](https://github.com/zhucourage/imgDB/images/image-20221107184844854.png)
...
![image-20221108213532940](https://github.com/zhucourage/imgDB/images/image-20221108213532940.png)
...
![image-20221108213746582](https://github.com/zhucourage/imgDB/images/image-20221108213951768.png)
...
![image-20221108213951768](https://github.com/zhucourage/imgDB/images/image-20221108213746582.png)
...
![image-20221108214051819](https://github.com/zhucourage/imgDB/images/image-20221109200122241.png)
...
- 交易的不同的输入和输出地址是可以被关联在一起的。比如网上购物比特币交易允许有多个输入和多个输出，因为某个人同时控制了两个账户的私钥，所以某个交易的 input 可能有两个账户。因为要买的那个东西一般很难恰好是某一个账户的全部的值，有一个很可能是找零钱的地址，所以 output 也可以有两个。一个交易可能会有多个输入，也会有多个输出。假设有一个这样的交易发布到了区块链上，可以认为输出的地址都是属于同一个人的。虽然比特币生成交易的时候并没有规定找零钱的地址在 output 当中出现的位置，但是在某些情况下，可以通过输出的金额分析出来，所以可以把输入地址跟输出地址也关联起来。
  ...
  ![image-20221109200122241](https://github.com/zhucourage/imgDB/images/image-20221108214051819.png)
